  ...
  return (
    <>
      <header className="no-print sticky top-0 z-30 border-b border-hairline bg-paper/90 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-7xl items-center gap-2 px-4 sm:gap-4 sm:px-5">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-ink text-[11px] font-bold text-white">
              DN
            </span>
            <span className="hidden text-sm font-semibold text-ink sm:inline">Dental Nation</span>
          </div>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              className="hidden items-center rounded-lg border border-hairline-strong px-2.5 py-1.5 text-sm text-ink-2 transition-colors hover:bg-panel sm:inline-flex"
            >
            ...
            <form action={logout}>
              <button
                type="submit"
                title="Sign out"
                className="inline-flex items-center gap-1.5 rounded-lg border border-hairline-strong px-2.5 py-1.5 text-sm text-ink-2 transition-colors hover:bg-panel sm:px-3"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="sm:hidden">
