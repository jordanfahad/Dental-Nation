    ...
    <Card>
      <div className="px-6 py-10 text-center">
        ...
        <p className="mx-auto mt-2 max-w-md text-[13px] leading-snug text-ink-soft">
          No CRM-DN appointments, conversations, or traffic are available for this view. This is an
          honest empty state — no figures are shown because none are sourced.
        </p>
        {canUpload ? (
          <p className="mt-3 text-[12.5px] text-ink-faint">
            Use the <span className="font-medium text-ink-soft">“Upload a fresh CRM-DN export”</span>{' '}
            panel above to ingest the latest CSV.
          </p>
        ) : (
          <p className="mt-3 text-[12.5px] text-ink-faint">
            An admin needs to upload a CRM-DN export. · owner: PAC
          </p>
        )}
      </div>
    </Card>
