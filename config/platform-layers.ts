  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        pnl: 'The bilingual site and 19,500+-page knowledge base convert organic demand into enquiries the group pays nothing per-click for — every organic booking displaces paid acquisition cost, and the content estate compounds rather than depreciates.',
      ...
      },
      {
        ...
        pnl: 'Intelligence spends the media budget where a dirham buys the most treatment value: audience segmentation and quality-tagged lead feedback steer spend toward channels that produce booked patients, not clicks — raising revenue per marketing dirham and cutting waste on unconvertible demand.',
        owner: 'Mr Fahad Siddiqui',
        status: 'built',
      ...
      },
      {
        ...
        pnl: '2,910 deduplicated leads YTD (live feed) top the treatment P&L; the governing economics is acquisition cost per booked patient, not per lead — and channel-level attribution lets losing channels be cut before they consume budget.',
        owner: 'Mr Fahad Siddiqui',
        status: 'built',
      ...
      },
      {
        ...
        coverage: '',
        evidence: [],
        pnl: 'Membership converts episodic patients into recurring, prepaid relationships: annual fees are cash collected against future care, retention lifts lifetime treatment value, and benefit usage drives visit frequency. Economics are gated on contribution after benefit-delivery cost, measured through the live 30-day activation mandate.',
        owner: 'Mr Gautam',
        status: 'in-implementation',
    ...
    capabilities: [
      {
        ...
        pnl: 'Speed-to-answer is revenue protection: every missed or slow-answered enquiry is paid demand lost — rapid qualification converts marketing spend into booked appointments instead of wasted clicks.',
      ...
      },
      {
        ...
        pnl: 'Lead-to-booking conversion is the highest-leverage ratio in the acquisition P&L: at a fixed media budget, each point of conversion is revenue at zero incremental acquisition cost. The 24-hour close rule and per-lead status tracking keep that pipeline honest.',
        owner: 'Mr Fahad Siddiqui · Dr Luvi Kaprani',
        status: 'built',
        refresh: 'Live — synced every 15 minutes',
        updated: SEEDED,
      ...
      },
      {
        ...
        pnl: 'Recalls and follow-up monetise patients already acquired: preventive recalls fill chair-hours at zero acquisition cost, and the follow-up pool re-activates treatment demand the group has already paid to generate.',
        owner: 'Dr Luvi Kaprani',
        status: 'in-implementation',
    ...
    capabilities: [
      {
        ...
        pnl: 'Governance is margin protection: daily branch reporting catches revenue leakage while it is still correctable, and formula-controlled commission reconciliation (August verified to AED 0.02) makes the group’s largest variable cost — clinician pay — auditable and dispute-free.',
        owner: 'Dr Luvi Kaprani',
        status: 'validate',
      ...
      },
      {
        ...
        pnl: 'Quality is the cheapest acquisition channel the group has: the 4.9★ public record converts directly into organic demand, while the compliance register (licenses, radiology registration, service contracts with expiry dates) protects the licence to operate — a single lapsed permit can halt a branch’s revenue overnight.',
        owner: 'Dr Luvi Kaprani',
        status: 'validate',
    ...
    capabilities: [
      {
        ...
        pnl: 'Centralisation converts three overheads into one: one finance feed, one procurement negotiation, one intake process. Unit costs fall as clinics are added — the operating-leverage core of the platform thesis.',
      ...
      },
      {
        ...
        coverage: '',
        evidence: [],
        pnl: 'The two-pillar structure keeps clinical and commercial accountability separate but coordinated: clear ownership shortens decisions, and shared roles across branches spread fixed people-cost over more revenue.',
        owner: 'Dr Luvi Kaprani',
        status: 'validate',
      ...
      },
      {
        ...
        pnl: 'Automation replaces manual reporting hours with machine feeds on a 15-minute cadence, and one data spine removes the hidden cost of reconciling conflicting numbers — decisions land days earlier on the same headcount.',
        owner: 'Mr Fahad Siddiqui',
        status: 'built',
      ...
      },
      {
        ...
        pnl: 'One verified number set for every decision: the dashboard removes the recurring cost of conflicting reports and makes doctor, branch and channel economics visible to the dirham — the lens that lets one management team run three clinics.',
        owner: 'Dr Luvi Kaprani',
        status: 'demonstrated',
      ...
      },
      {
        ...
        pnl: 'Target-vs-actual pacing on a live feed turns month-end surprises into same-week corrections — underperformance is fixed or cut while the month is still winnable.',
