...
const TASKS_RAW: TeamTask[] = [
  ...
  { key: 'f-google-gate', who: 'fahad', wk: 2, dueIso: '2026-10-05', due: 'Mon 5 Oct', task: 'Decide whether Google gets more budget',
    ...
    steps: [
      ...
      { s: 'Decide', how: 'AED 600 or less per online member → release; above that → hold, and move the AED 3,000 reserve to the cheapest segment instead.' },
  ...
  { key: 'g-incentives', who: 'gautam', wk: 1, dueIso: '2026-09-25', due: 'Fri 25 Sep', task: 'Agree the results-only thank-yous with Finance',
    ...
    steps: [
      ...
      { s: 'Team told', how: 'Dr Luvi announces it at the receptionist refresher and to the dentists.' },
    ],
