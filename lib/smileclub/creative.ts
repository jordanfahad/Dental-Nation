...
const CONFIRM_PLANS = 'Current plan prices (Essential AED 99/month or AED 999/year; Plus AED 139/month or AED 1,399/year — read on the public page 12 Sep) and exactly what each plan includes — Gautam.';
...
export const CONCEPTS: Record<string, Concept> = {
  subscriptions: {
    ...
    beats: [
      ...
      { v: 'Doctor to camera, in the surgery.', who: 'doctor',
        say: { en: 'Most people only see a dentist when something hurts — and that’s when it costs the most.', ar: 'معظم الناس لا يزورون طبيب الأسنان إلا عند الألم، وهنا تكون التكلفة الأعلى.', tr: 'Çoğu insan dişçiye ancak bir yeri ağrıdığında gider; en pahalı olan da tam o andır.' } },
      { v: 'Price card slides in beside the doctor.', who: 'doctor', priced: true,
        ...
        say: { en: 'Smile Club puts your teeth on a plan too — from AED 99 a month. That’s about three dirhams a day.', ar: 'Smile Club يضع أسنانكم على خطة أيضاً، من 99 درهماً في الشهر، أي نحو ثلاثة دراهم في اليوم.', tr: 'Smile Club dişlerinizi de bir plana bağlar; aylık 99 AED’den başlayan fiyatlarla.' },
        alt: { say: { en: 'Smile Club puts your teeth on a plan too — care that’s planned, not postponed.', ar: 'Smile Club يضع أسنانكم على خطة أيضاً: عناية مخطّطة بدلاً من التأجيل.', tr: 'Smile Club dişlerinizi de bir plana bağlar: ertelenen değil, planlanan bir bakım.' } } },
  ...
  toothache: {
    ...
    beats: [
      ...
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'That’s why we created Smile Club: your check-ups planned for the year — and help when something urgent does happen.', ar: 'لهذا أطلقنا Smile Club: فحوصاتكم مخطّطة طوال العام، ومساعدة عند حدوث أمر طارئ.', tr: 'Smile Club’ı bu yüzden oluşturduk: yıl boyunca planlanmış diş kontrolleri ve acil bir durumda destek.' } },
    ...
    confirm: [CONFIRM_PLANS, 'Which plans include “help when you have an urgent dental problem”, and what that help is.', 'DN SOS price AED 699 is current.'],
  },
  ...
  postponer: {
    ...
    angle: 'Convenience — care planned for you', tier: 'Essential',
    ...
    beats: [
      ...
      { v: 'Doctor to camera; calendar graphic fills with two dates.', who: 'doctor',
        ...
        say: { en: 'Smile Club takes the planning off your hands: your check-ups are planned for the year, with priority appointments that fit your week.', ar: 'Smile Club يتولّى التخطيط عنكم: فحوصاتكم مخطّطة طوال العام، مع أولوية في المواعيد بما يناسب أسبوعكم.', tr: 'Smile Club planlamayı sizin yerinize yapar: diş kontrolleriniz yıl boyunca planlanır, haftanıza uyan öncelikli randevularla.' } },
  ...
  bigday: {
    ...
    angle: 'Plan ahead — always photo-ready, not rushed', tier: 'Plus (from AED 139/month)',
    ...
    beats: [
      ...
      { v: 'Doctor to camera, polishing cup or scaler in shot.', who: 'doctor',
        say: { en: 'A professional cleaning makes a real difference — but the best results come from care that’s planned, not rushed.', ar: 'التنظيف الاحترافي يُحدث فرقاً حقيقياً، لكن أفضل النتائج تأتي من عناية مخطّطة لا مستعجلة.', tr: 'Profesyonel temizlik gerçekten fark yaratır; ama en iyi sonuç aceleyle değil, planlı bakımla gelir.' } },
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'With Smile Club, your cleanings are part of the year — so you’re ready for every big day, not just one.', ar: 'مع Smile Club، يصبح التنظيف جزءاً من عامكم، فتكونون مستعدّين لكل مناسبة، لا لمناسبة واحدة فقط.', tr: 'Smile Club ile temizlikleriniz yılın bir parçası olur; böylece yalnızca bir güne değil, her büyük güne hazır olursunuz.' } },
  ...
  honest: {
    ...
    beats: [
      ...
      { v: 'Doctor, reassuring.', who: 'doctor',
        say: { en: 'If you had to think about it, you’re not alone — and there’s no judgement here.', ar: 'إذا احتجتم للتفكير، فلستم وحدكم، ولا أحد هنا سيحكم عليكم.', tr: 'Düşünmeniz gerektiyse yalnız değilsiniz; burada kimse sizi yargılamaz.' } },
      { v: 'Doctor to camera.', who: 'doctor',
  ...
  braces: {
    ...
    angle: 'Transparent costs — then healthy teeth throughout treatment', tier: 'Essential during treatment',
    ...
    beats: [
      ...
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'Fair question. The honest answer depends on your teeth — which is why guessing never helps.', ar: 'سؤال منطقي. والجواب الصادق يعتمد على أسنانكم، ولهذا لا يفيد التخمين.', tr: 'Haklı bir soru. Dürüst cevap dişlerinize bağlı; bu yüzden tahmin etmek işe yaramaz.' } },
      { v: 'Cost card beside the doctor.', who: 'doctor', priced: true,
        ...
        say: { en: 'The DN Scan gives you a 3D scan, a consultation and a written plan with the full cost — AED 499, fully deducted if you go ahead.', ar: 'The DN Scan يمنحكم مسحاً ثلاثي الأبعاد واستشارة وخطة مكتوبة بالتكلفة الكاملة، بـ 499 درهماً تُخصم بالكامل إذا بدأتم العلاج.' },
      ...
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'And during treatment, Smile Club keeps your check-ups and cleanings on track — because straight teeth still need healthy gums.', ar: 'وخلال العلاج، يحافظ Smile Club على انتظام فحوصاتكم وتنظيف أسنانكم، فالأسنان المستقيمة تحتاج أيضاً إلى لثة سليمة.', tr: 'Tedavi sırasında da Smile Club kontrollerinizi ve temizliklerinizi düzenli tutar; çünkü düz dişler de sağlıklı diş etlerine ihtiyaç duyar.' } },
      { v: 'End card.', os: { en: 'Know before you commit. The DN Scan + Smile Club — message us on WhatsApp.', ar: 'اعرفوا قبل أن تلتزموا. The DN Scan وSmile Club — راسلونا على واتساب.', tr: 'Karar vermeden önce bilin. The DN Scan + Smile Club — bize WhatsApp’tan yazın.' } },
    ],
    confirm: [CONFIRM_PLANS, 'The DN Scan AED 499, fully deducted — current.'],
  },
  ...
  gums: {
    ...
    beats: [
      ...
      { v: 'Doctor to camera; calendar graphic with cleaning dates.', who: 'doctor',
        say: { en: 'Smile Club plans your check-ups and professional cleanings for the year — so it’s caught early, every time.', ar: 'Smile Club يخطّط لفحوصاتكم وتنظيف أسنانكم طوال العام، لتُكتشف المشكلة مبكراً في كل مرة.', tr: 'Smile Club kontrollerinizi ve profesyonel temizliklerinizi yıl boyunca planlar; böylece sorun her seferinde erken yakalanır.' } },
  ...
  'lane-scan': {
    ...
    beats: [
      ...
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'The DN Scan: a 3D scan of your teeth, a consultation with an orthodontist and a written plan — braces or aligners, and roughly how long.', ar: 'The DN Scan: مسح ثلاثي الأبعاد لأسنانكم، واستشارة مع أخصائي تقويم، وخطة مكتوبة: تقويم ثابت أو شفاف، والمدة التقريبية.', tr: 'The DN Scan: dişlerinizin üç boyutlu taraması, bir ortodonti uzmanıyla görüşme ve yazılı plan; diş teli mi şeffaf plak mı, yaklaşık ne kadar sürer.' } },
      { v: 'Cost card.', who: 'doctor', priced: true,
        ...
        say: { en: 'AED 499 — and it’s fully deducted if you start treatment.', ar: 'بـ 499 درهماً، تُخصم بالكامل إذا بدأتم العلاج.' },
      ...
      { v: 'End card.', os: { en: 'Book The DN Scan — link in the ad, or message us on WhatsApp.', ar: 'احجزوا The DN Scan — الرابط في الإعلان أو راسلونا على واتساب.', tr: 'The DN Scan randevusu — reklamdaki bağlantı ya da WhatsApp.' } },
    ],
    ...
    confirm: ['The DN Scan AED 499, fully deducted — current.'],
  },

  'lane-firstlook': {
    id: 'lane-firstlook', name: 'The DN First Look — what I see that you can’t', kind: 'lane',
    audience: 'Anyone overdue a check-up', need: 'Knowing where their teeth stand — without surprises',
    ...
    beats: [
      ...
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'Early decay, a filling starting to fail, gum changes — none of it hurts at first.', ar: 'تسوّس في بدايته، حشوة بدأت تتلف، تغيّرات في اللثة… لا شيء منها يؤلم في البداية.', tr: 'Başlangıçtaki çürük, eskiyen bir dolgu, diş eti değişiklikleri… Hiçbiri ilk başta ağrı yapmaz.' } },
      { v: 'Doctor to camera.', who: 'doctor',
      ...
      { v: 'Cost card.', who: 'doctor', priced: true,
        ...
        say: { en: 'AED 799, all-inclusive — no surprises.', ar: 'بـ 799 درهماً شاملة كل شيء، بلا مفاجآت.' },
      ...
      { v: 'End card.', os: { en: 'Book The DN First Look — link in the ad, or message us on WhatsApp.', ar: 'احجزوا The DN First Look — الرابط في الإعلان أو راسلونا على واتساب.', tr: 'The DN First Look randevusu — reklamdaki bağlantı ya da WhatsApp.' } },
    ],
    ...
    confirm: ['The DN First Look AED 799 all-inclusive — current.'],
  },
  ...
  'lane-glowup': {
    ...
    angle: 'A tangible, everyday comparison', tier: 'The DN Glow Up (AED 1,699, all-inclusive)',
    ...
    beats: [
      ...
      { v: 'Doctor holding a shade guide up to the camera.', who: 'doctor',
        say: { en: 'Your teeth notice. Most staining sits in the outer layer — which is why professional whitening works.', ar: 'وأسنانكم تلاحظ ذلك. معظم التصبّغات في الطبقة الخارجية، ولهذا ينجح التبييض الاحترافي.', tr: 'Dişleriniz bunu fark eder. Renklenmelerin çoğu dış katmandadır; profesyonel beyazlatmanın işe yaramasının nedeni budur.' } },
      { v: 'Doctor to camera.', who: 'doctor',
        say: { en: 'The DN Glow Up is professional Zoom whitening, supervised by a dentist, in about an hour — and we check first that it’s right for you.', ar: 'The DN Glow Up تبييض احترافي بتقنية Zoom بإشراف طبيب، في نحو ساعة، ونتأكّد أولاً من أنه مناسب لكم.', tr: 'The DN Glow Up, diş hekimi gözetiminde yaklaşık bir saat süren profesyonel Zoom beyazlatmadır; önce size uygun olup olmadığını kontrol ederiz.' } },
      { v: 'Price card.', priced: true, os: { en: 'AED 1,699 · all-inclusive', ar: '1,699 درهماً · شاملة كل شيء' } },
      { v: 'End card.', os: { en: 'Keep the coffee. Brighten the smile. Book The DN Glow Up — link in the ad or WhatsApp.', ar: 'احتفظوا بقهوتكم، وأشرقوا بابتسامتكم. احجزوا The DN Glow Up — الرابط في الإعلان أو واتساب.', tr: 'Kahveden vazgeçmeyin, gülüşünüzü aydınlatın. The DN Glow Up — reklamdaki bağlantı ya da WhatsApp.' } },
    ],
    confirm: ['The DN Glow Up AED 1,699 all-inclusive — current.'],
  },
  ...
  'lane-sos': {
    ...
    beats: [
      ...
      { v: 'Price card.', who: 'doctor', priced: true,
        ...
        say: { en: 'AED 699, all-inclusive — you know the price before you arrive.', ar: 'بـ 699 درهماً شاملة كل شيء، وتعرفون السعر قبل الوصول.' } },
