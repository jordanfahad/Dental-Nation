...
export const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    scripts: [
      { label: 'ACTIVE — check-up due', text: '“Hi ___, it’s Dr Hasna from Dental Nation. Your check-up is due. Smile Club offers included check-ups and cleanings and member rates, with plans from AED 99 a month. Would you like the plan details or a booking? Reply STOP to stop messages.”' },
      { label: 'INACTIVE — 6–18 months', text: '“Hi ___, Dr Tosun here from Dental Nation. It’s been a while since your last visit. Smile Club includes planned check-ups; I can explain what the membership includes if you’re interested. Would you like a booking? Reply STOP to stop messages.”' },
      { label: 'DORMANT — over 18 months', text: '“Hi ___, Dr Maisoon from Dental Nation. If you’d like to return, I can explain the check-up included in a Smile Club membership or arrange a visit. There’s no pressure to join. Reply STOP to stop messages.”' },
    ],
