...
export const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    scripts: [
      ...
      { label: 'DORMANT — over 18 months', text: '“Hi ___, Dr Maysoon from Dental Nation. If you’d like to return, I can explain the check-up included in a Smile Club membership or arrange a visit. There’s no pressure to join. Reply STOP to stop messages.”' },
    ],
