...
export const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    message: 'One short WhatsApp from the patient’s own dentist, different for each group — a nudge for those due, a welcome back for those who have drifted. It goes to the whole group, never addressed to an individual, in the branch’s two languages: Turkish + English at Dr. Tosun Dental Clinic, Arabic + English at Al Wasl and Al Maher.',
    how: [
