...
export const SEGMENTS: Segment[] = [
  {
    id: 'chair', name: 'Patients in the chair today', owner: 'Dr Luvi accountable · treating dentists and receptionists deliver',
  ...
  {
    id: 'patients', name: 'Our patients who are not visiting', owner: 'Dr Luvi accountable · treating dentists and CRM-DN deliver',
    who: 'Existing Dental Nation patients grouped once by their own treating dentist: active patients due a check-up under their care plan first; among the remaining patients, inactive means last seen 6–18 months ago including exactly 18, and dormant means last seen over 18 months ago.',
    target: 24, targetNote: 'Active-due 10 · inactive 8 · dormant 6',
    messenger: 'Each dentist writes only to their OWN patients, in their own name — Dr Hasna to Dr Hasna’s patients, Dr Tosun to Dr Tosun’s, Dr Maysoon to Dr Maysoon’s, and so on for every treating dentist. Never a blanket message from “Dental Nation”.',
    message: 'One short WhatsApp from the patient’s own dentist, different for each group — a nudge for those due, a welcome back for those who have drifted. It goes to the whole group, never addressed to an individual, in the languages that dentist’s patients speak: Turkish + English for the Turkish dentists at Dr. Tosun Dental Clinic, Arabic + English at Al Wasl and Al Maher, English only where that is what the patients speak (e.g. Dr. Sathyapriya Surendar).',
    how: [
      ...
      { title: '3 · Small daily batches', body: 'At most 20 messages per dentist per day across waves, reminders and automatic messages combined. Check consent and opt-outs before every send. The branch answers replies the same day and arranges a booking only when requested.' },
    ...
    scripts: [
      { label: 'ACTIVE — check-up due (Al Wasl · Arabic + English)', text: '“Hello, this is Dr. Hasna Alsaeed from Dental Nation Al Wasl. Your next check-up is coming up, so it’s a good moment to tell you about something new. Smile Club offers included check-ups and cleanings and member rates, with plans from AED 99 a month. Just reply and my team will explain the plans and book your check-up. (Reply STOP to stop messages.)”' },
      { label: 'INACTIVE — 6–18 months (Dr. Tosun Dental Clinic · Turkish + English)', text: '“Hello, this is Dr. Yahya Tosun from Dr. Tosun Dental Clinic, part of Dental Nation. It’s been a while since your last visit, and I wanted to check in. Smile Club is an easy way to get your dental care back on track. Reply and my team will explain the plans and find a time that suits you. (Reply STOP to stop messages.)”' },
      { label: 'DORMANT — over 18 months (Dr. Tosun Dental Clinic · Turkish + English)', text: '“Hello, this is Dr. Maysoon Abdelmajeed from Dr. Tosun Dental Clinic, part of Dental Nation. It’s been a long time since we last saw you — you are always welcome back, with no pressure at all. If you’d like to hear about Smile Club, just reply and my team will explain — no obligation. (Reply STOP to stop messages.)”' },
    ],
  ...
  {
    id: 'search', name: 'People searching online', owner: 'Fahad accountable · CRM-DN runs pages, tracking and replies',
    ...
    unlock: 'Initial online allocation: AED 3,500, subject to the required human sign-off. A further AED 3,500 (Google +1,500, Facebook/Instagram +2,000) stays on hold until the 5 Oct review and is eligible only if a paid online membership has cost AED 600 or less. No paid memberships means the hold remains.',
  ...
  {
    id: 'community', name: 'Families & neighbourhoods', owner: 'Fahad accountable · Dr Luvi runs the event · Mohan produces materials',
    ...
    how: [
      { title: 'Awareness goes offline', body: 'Reach families through local places they trust. The AED 5,500 allocation is AED 2,000 for printed material, AED 1,500 for one community event and AED 2,000 shared across partner and promoter commissions. There is no separate digital awareness budget.' },
