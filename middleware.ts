...
export const config = {
  ...
  matcher: ['/((?!login|reports/arabyads|api/cron|api/practo|api/meta|api/google-ads|api/notify|api/widget-health|Leave-Calendar|api/leave-|_next/static|_next/image|favicon.ico).*)'],
};
